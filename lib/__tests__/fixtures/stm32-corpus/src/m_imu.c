...
int main(void){
  ...
  __HAL_RCC_USART2_CLK_ENABLE(); __HAL_RCC_I2C1_CLK_ENABLE();
  ...
  GPIO_InitTypeDef gi={0}; gi.Pin=GPIO_PIN_6|GPIO_PIN_7; gi.Mode=GPIO_MODE_AF_OD; gi.Pull=GPIO_PULLUP; gi.Alternate=GPIO_AF6_I2C1; gi.Speed=GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOB,&gi);
  hu.Instance=USART2; hu.Init.BaudRate=115200; hu.Init.WordLength=UART_WORDLENGTH_8B; hu.Init.StopBits=UART_STOPBITS_1;
  ...
  HAL_UART_Init(&hu);
  hi.Instance=I2C1; hi.Init.Timing=0x10707DBC; hi.Init.OwnAddress1=0; hi.Init.AddressingMode=I2C_ADDRESSINGMODE_7BIT;
  hi.Init.DualAddressMode=I2C_DUALADDRESS_DISABLE; hi.Init.GeneralCallMode=I2C_GENERALCALL_DISABLE; hi.Init.NoStretchMode=I2C_NOSTRETCH_DISABLE;
  HAL_I2C_Init(&hi);
  uint8_t who=0;
