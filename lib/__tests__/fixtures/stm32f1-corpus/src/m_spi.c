...
int main(void){
  ...
  GPIO_InitTypeDef g={0}; g.Pin=GPIO_PIN_5|GPIO_PIN_7; g.Mode=GPIO_MODE_AF_PP; g.Speed=GPIO_SPEED_FREQ_HIGH; HAL_GPIO_Init(GPIOA,&g);
  ...
  uint8_t cmd[4]={0xAE,0xA8,0x3F,0xAF};
